...
export class SurveyComponent implements OnInit, OnDestroy {
  ...
  constructor(private clientService: ClientService, private app: AppComponent, private authService: AuthenticationService) { }
  ...
  ngOnInit() {
    if (this.authService.check("client")) {
      ...
      if (finishedSurvey) {
        ...
        let surveyName = JSON.parse(sessionStorage.getItem('currSurveyNameClient'));

        this.clientService.getSurvey(surveyName).subscribe(survey => {
  ...
  endSurvey() {
    ...
    this.clientService.endSurvey(this.survey).subscribe((resSurvey) => {
      console.log(resSurvey);
      this.clientService.updateUser(user).subscribe(resUpdate => {
